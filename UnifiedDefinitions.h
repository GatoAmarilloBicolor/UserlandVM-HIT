/**
 * @file UnifiedDefinitions.h
 * @brief Centralized definitions for UserlandVM - fixes all inconsistencies
 */
...
// Include elf.h with fallback to manual definitions if needed
